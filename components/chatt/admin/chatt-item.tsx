...
export const ChattItem=({conversation,setSelectedUser}:Props)=>{
 ...
 return(
    ...
    <div className="py-2 px-3 bg-grey-lighter flex flex-row justify-between items-center" onClick={()=>setSelectedUser(conversation?.user!)}>
        <div>
